const cadastro = [
  ...
  const sendbotao = document.querySelector("#botaoSend");
  ...
  function enviarCadastro() {
    ...
    const estadoipt = document.querySelector("select[name='estado']").value;
    const cidadeipt = document.querySelector("input[name='cidade']").value;
    const cepipt = document.querySelector("input[name='cep']").value;
    const informacaoipt = document.querySelector("textarea[name='opiniao']").value;
  ...
  sendbotao.addEventListener("click", enviarCadastro);
